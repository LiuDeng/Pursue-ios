...
/**
 * Main parts of the DetailViewController
 *
 ...
 *
 * @param option The option key. Keys are defined in DetailViewController.h
 *
 ...
 *
 * @param component The component key. Keys are defined in DetailViewController.h
 *
 ...
 */
- (UIView *)viewPager:(DetailViewController *)viewPager contentViewForTabAtIndex:(NSUInteger)index;
 ...
 */
- (void)viewPager:(DetailViewController *)viewPager didChangeTabToIndex:(NSUInteger)index;
/**
 ...
 * @return A CGFloat, defining the setting for the given option
 */
- (CGFloat)viewPager:(DetailViewController *)viewPager valueForOption:(ViewPagerOption)option withDefault:(CGFloat)value;
 ...
 * @return A UIColor for the given component
 */
- (UIColor *)viewPager:(DetailViewController *)viewPager colorForComponent:(ViewPagerComponent)component withDefault:(UIColor *)color;
