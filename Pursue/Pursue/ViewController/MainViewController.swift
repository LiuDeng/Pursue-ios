...
//        messageBarItem.badgeValue = "3"
        ...
        var profileViewController = ProfileViewController(nibName: "RecordView", bundle: nil)
        profileViewController.tabBarItem = profileBarItem
        
        self.viewControllers = [focusViewController, searchViewController, recordViewController, messageViewController, profileViewController]
    }
